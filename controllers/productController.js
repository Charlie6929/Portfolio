...
/**
 * Schema di validazione per un prodotto (POST)
 */
...
/**
 * Schema di validazione per update (PUT)
...
exports.updateProduct = async (req, res) => {
  try {
    // Consentire aggiornamento solo dei campi inviati
    const updateData = {};
    ...
    // Validazione dei dati aggiornati (tutti opzionali)
